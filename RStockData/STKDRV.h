...
public:
	...
	static int GetStockByNoEx(int nNo,RCV_REPORT_STRUCTExV3* pBuf);
...
private:
	...
	static int (WINAPI* m_pfnGetStockByNoEx)(int nNo,RCV_REPORT_STRUCTExV3* pBuf);
